...
public class AuthService {
    ...
    public AuthService(AuthenticationManager authenticationManager, UserRepository userRepository,
                    ...
                    EmailService emailService, StudentService studentService, TeacherService teacherService) {
    ...
    private void createTeacherRecord(User user, RegisterRequest request) {
        try {
            teacherService.createTeacher(user, request);
        } catch (Exception e) {
            System.err.println("Teacher record creation failed: " + e.getMessage());
