...
const StudentDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      console.log('Today info:', { today, todayName })
      console.log('Available timetables:', timetable)
      console.log('Timetable days:', timetable.map(t => ({ id: t.id, day: t.dayOfWeek, subject: t.subject })))
